---
name: graphify
description: Generate knowledge graph from codebase. Use automatically when exploring a new/unfamiliar project for the first time, when user asks to understand architecture or map dependencies, or when codebase changed significantly. Also use for any input (code, docs, papers, images) to knowledge graph.
---
