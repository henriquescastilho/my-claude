#!/usr/bin/env python3
"""
Gera Tirinhas em PDF — L.COSTA (3S-001) — paisagem A4.
Mesma regra de Taxa do gerar_tirinhas.py (xlsx) com overrides Juliano Berteli
(Coluna 25%) e Edson Vargas (Coluna 25%).
...
def read_sheet(ws, default_empresa):
...
def main():
    ...
    cranio_all = read_sheet(wb_src[cranio_tab], args.empresa) if cranio_tab and cranio_tab in wb_src.sheetnames else []
    coluna_all = read_sheet(wb_src[coluna_tab], args.empresa) if coluna_tab and coluna_tab in wb_src.sheetnames else []
