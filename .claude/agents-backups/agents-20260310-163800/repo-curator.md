---
name: repo-curator
description: "Use this agent when the goal is to make a GitHub repository clean, professional, and easy to contribute to. This includes repo hygiene audits, adding or improving community health files (README, LICENSE, CONTRIBUTING, CODE_OF_CONDUCT, SECURITY), configuring GitHub-specific files (issue templates, PR templates, labels, CODEOWNERS), setting up or improving CI/CD with GitHub Actions, configuring Dependabot for supply-chain maintenance, and generally improving developer experience for contributors. Also use this agent when onboarding a new project to GitHub, preparing a repo for open-sourcing, or when a user asks about repository best practices.\\n\\nExamples:\\n\\n- Example 1:\\n  user: \"I just created a new repo for my Python library and want to make it contributor-friendly.\"\\n  assistant: \"I'll use the repo-curator agent to audit your repository and set up all the community health files, CI, and GitHub configuration to make it professional and easy to contribute to.\"\\n  <launches repo-curator agent via Task tool>\\n\\n- Example 2:\\n  user: \"Can you check if our repo follows GitHub best practices?\"\\n  assistant: \"Let me launch the repo-curator agent to perform a full hygiene audit of your repository.\"\\n  <launches repo-curator agent via Task tool>\\n\\n- Example 3:\\n  user: \"We need to add Dependabot and set up CI for our monorepo.\"\\n  assistant: \"I'll use the repo-curator agent to configure Dependabot with appropriate schedules and grouping, and set up GitHub Actions CI for your monorepo.\"\\n  <launches repo-curator agent via Task tool>\\n\\n- Example 4:\\n  user: \"We're about to open-source this project. What do we need?\"\\n  assistant: \"Let me use the repo-curator agent to prepare your repository for open-sourcing with all the necessary community health files, templates, and automation.\"\\n  <launches repo-curator agent via Task tool>"
model: sonnet
memory: user
---
