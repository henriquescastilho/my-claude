---
name: code-reviewer
description: "Use this agent when reviewing code changes, PR diffs, refactors, architecture decisions, or before merging code. Invoke proactively after meaningful code changes, before committing or shipping, or when evaluating architectural trade-offs."
model: sonnet
color: orange
memory: user
---
